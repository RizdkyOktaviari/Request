                ...
                <div class="row">
                    <div class="col-lg-10">
                        <div class="content_wrapper">
                            <h3 class="title">You're Using Free Version of ClassiFied</h3>
                            <p>Please, purchase full version of the template to get all pages, features and permission to use in commercial projects.</p>
                            <ul class="header_btn">
                                <li><a class="main-btn" href="https://rebrand.ly/classified-gg" rel="nofollow">Purchase Now</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-7 col-sm-8">
                        <div class="single_locations mt-30">
                            ...
                            <div class="locations_content">
                                <h5 class="title"><a href="product.html"><i class="far fa-map"></i>California</a></h5>
